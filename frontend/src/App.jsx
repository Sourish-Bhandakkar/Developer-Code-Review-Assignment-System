      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-16 bg-surface-300/40 backdrop-blur-md border-b border-glass flex items-center justify-between px-4 md:px-8 shadow-lg z-20">
          ...
          <div className="flex items-center gap-4">
            {/* Notification Bell */}
            <div className="relative p-2 hover:bg-white/5 text-primary-300 hover:text-white rounded-xl transition-all cursor-pointer">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 max-w-[1450px] w-full mx-auto relative z-10">
          <Outlet />
        </main>
      </div>
    </div>
